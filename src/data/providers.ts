...
export const providers: Provider[] = [
  ...
  },
  {
    slug: "netnut",
    name: "NetNut",
    tagline: "Currently under investigation - domain seized",
    rating: 1.0,
    startingPriceGB: 4.5,
    poolSize: "Unavailable",
    countries: 0,
    bestFor: "Not recommended - see status update",
    proxyTypes: ["residential", "datacenter", "isp", "mobile", "scraping-api"],
    founded: 2017,
    hq: "Tel Aviv, Israel",
    pros: [],
    cons: ["Domain seized by FBI/DOJ/IRS-CI in July 2026", "Tied to the Popa botnet built from 2M+ hijacked consumer devices", "Service disrupted and not currently operational", "Do not sign up or send payment until the situation is resolved"],
    shortDescription:
